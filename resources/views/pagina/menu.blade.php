            ...
            <div class="container">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href=""><i class="fa fa-sitemap" aria-hidden="true"></i> Consejo Superior Universitario</a></li>
                                    <li><a href=""><i class="fa fa-sitemap" aria-hidden="true"></i> Consejo Académico</a></li>
                                    <li><a href=""><i class="fa fa-sitemap" aria-hidden="true"></i> Consejo Electoral Universitario</a></li>
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Presentación</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Misión</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Visión</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Objetivo Retador</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Organigrama</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Historia</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> PEI</a></li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Sedes</a></li>
                                </ul>
                            </li>
                            <!-- End Shop UI -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu">
                                <a href="">Vice. Académica</a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        <a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Vice. Asistente de estudios</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="javascript:void(0);">Quiénes Somos</a>
                                                <ul style="list-style: none;">
                                                    <li><a href="" class="dropdown-menu-submenu">Presentación</a></li>
                                                    <li><a href="" class="dropdown-menu-submenu">Funciones</a></li>
                                                </ul></li>
                                            <li><a href="">Dependencias</a></li>
                                            <li><a href="">Grupo de Trabajo</a></li>
                                        </ul>
                                    </li>
                                    <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Vice. Asist. de investigación y extensión</a></li>
                                </ul>
                            </li>
                            <!-- End Blog Template -->
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:void(0);"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Quiénes somos</a>
                                        <ul style="list-style: none;">
                                            <li><a href="" class="dropdown-menu-submenu"><i class="fa fa-angle-right" aria-hidden="true"></i> Presentación</a></li>
                                        </ul></li>
                            </li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Derechos pecuniarios</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Normatividad</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Grupo de Trabajo</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Formatos</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Tarifas de servicio de extensión</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Ejecuciones presupuestales</a></li>
                            <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Presupuesto</a></li>
                        </ul>
                    </li>
                    <!-- End Service Pages -->
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="javascript:void(0);"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Quienes somos</a>
                                     <ul style="list-style: none;">
                                            <li><a href="" class="dropdown-menu-submenu"><i class="fa fa-angle-right" aria-hidden="true"></i> Misión</a></li>
                                            <li><a href="" class="dropdown-menu-submenu"><i class="fa fa-angle-right" aria-hidden="true"></i> Visión</a></li>
                                            <li><a href="" class="dropdown-menu-submenu"><i class="fa fa-angle-right" aria-hidden="true"></i> Objetivos</a></li>
                                        </ul>
                                </li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Fundamentos</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Elementos</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Principios</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Procedimientos</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Informes</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="javascript:void(0);"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Quienes somos</a>
                                    <ul style="list-style: none;">
                                        <li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i> Propósito principal</a></li>
                                        <li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i> Funciones</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0);"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Unidades</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="">Planeación económico-financiera</a></li>
                                        <li><a href="">Información y estadística</a></li>
                                        <li><a href="">Planeación física</a></li>
                                    </ul>
                                </li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Gestión de calidad</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Plan anticorrupción</a></li>
                                <li><a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i> Estructura orgánica</a></li>
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0);"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Plan de acción institucional</a>
                                 <ul class="dropdown-menu">
                                        <li><a href="">Plan de acción 2014</a></li>
                                ...
                                <div class="row equal-height">
                                    <div class="col-md-3 equal-height-in">
                                        <ul class="list-unstyled equal-height-list">
                                            ...
                                            <li><a href="">Facultad de Ciencias Agrarias y del Ambiente</a></li>


                                            <li class="title-menu-ofer margin-top-20"><h3>Programas Tecnológicos</h3></li>

                                            <!-- Common Elements -->
                                            <li><a href="">Tecnología Agroindustrial</a></li>
                                    ...
                                    <div class="col-md-3 equal-height-in">
                                        <ul class="list-unstyled equal-height-list">
                                            ...
                                            <!-- Forms -->
                                            <li><a href="">Técnico Profesional en Fabricación Industrial de Productos Cerámicos</a></li>
                                            <li><a href="">Técnico Profesional en Procesamiento de Alimentos</a></li>
                                            <li><a href="">Técnico Profesional en Procesos de Manufactura de Calzado y Marroquinería</a></li>
                                            <li><a href="">Técnico Profesional en Producción de Cerámica Artesanal</a></li>
                                            <!-- End Forms -->
                                            <li class="title-menu-ofer margin-top-20"><a href="" class="no-padding"><h5>Programas de Distancia</h5></a></li>
                                            <!-- Forms -->
                                            <li><a href="">Licenciatura en Informática</a></li>
                                            <li><a href="">Tecnología Comercial y Financiera</a></li>
                                            <li><a href="">Tecnología en Regencia de Farmacia</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-3 equal-height-in">
                                        <ul class="list-unstyled equal-height-list">
                                            <li class="title-menu-ofer"><a href="" class="no-padding"><h3>Programas de Posgrados</h3></a></li>
                                            <!-- Forms -->
                                            <li class="title-menu-ofer"><h5>Especializaciones</h5></li>
                                            <li><a href="">Especialización en Aseguramiento de la Calidad</a></li>
                                          <!-- End Forms -->
                                            <!-- Forms -->
                                            <li class="title-menu-ofer margin-top-20"><h5>Maestrías</h5></li>
                                            <li><a href="">Maestría en Ciencia y Tecnología de Materiales</a></li>
                                            <!-- End Forms -->
